...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('autonomy_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'autonomy_msgs.msg.DetectionArray')
            logger.debug(
            ...
            from autonomy_msgs.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<autonomy_msgs/Detection>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autonomy_msgs', 'msg'], 'Detection')),  # noqa: E501
    )
