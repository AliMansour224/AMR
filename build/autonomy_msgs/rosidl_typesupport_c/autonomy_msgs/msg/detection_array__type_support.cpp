...
static const _DetectionArray_type_support_symbol_names_t _DetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autonomy_msgs, msg, DetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autonomy_msgs, msg, DetectionArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autonomy_msgs, msg, DetectionArray)() {
  return &::autonomy_msgs::msg::rosidl_typesupport_c::DetectionArray_message_type_support_handle;
}
