...
#include "autonomy_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autonomy_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autonomy_msgs::msg::Detection & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autonomy_msgs::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autonomy_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autonomy_msgs::msg::Detection *>(
    untyped_ros_message);
...
get_message_type_support_handle<autonomy_msgs::msg::Detection>()
{
  return &autonomy_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonomy_msgs, msg, Detection)() {
  return &autonomy_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
