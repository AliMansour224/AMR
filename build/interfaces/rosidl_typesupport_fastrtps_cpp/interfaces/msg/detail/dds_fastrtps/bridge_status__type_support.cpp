...
#include "interfaces/msg/detail/bridge_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::BridgeStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::BridgeStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_BridgeStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::BridgeStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_key_BridgeStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces::msg::BridgeStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::BridgeStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BridgeStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::msg::BridgeStatus *>(
...
static size_t _BridgeStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BridgeStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BridgeStatus__callbacks = {
  "interfaces::msg",
  "BridgeStatus",
...
static rosidl_message_type_support_t _BridgeStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BridgeStatus__callbacks,
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_BridgeStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, BridgeStatus)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_BridgeStatus__handle;
}
