...
#include "interfaces/msg/detail/safety_status__rosidl_typesupport_fastrtps_c.h"
...
using _SafetyStatus__ros_msg_type = interfaces__msg__SafetyStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_interfaces__msg__SafetyStatus(
  const interfaces__msg__SafetyStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_deserialize_interfaces__msg__SafetyStatus(
  eprosima::fastcdr::Cdr & cdr,
  interfaces__msg__SafetyStatus * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__msg__SafetyStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__SafetyStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__SafetyStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
bool cdr_serialize_key_interfaces__msg__SafetyStatus(
  const interfaces__msg__SafetyStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_key_interfaces__msg__SafetyStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SafetyStatus__ros_msg_type * ros_message = static_cast<const _SafetyStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_key_interfaces__msg__SafetyStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const interfaces__msg__SafetyStatus * ros_message = static_cast<const interfaces__msg__SafetyStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_interfaces__msg__SafetyStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  interfaces__msg__SafetyStatus * ros_message = static_cast<interfaces__msg__SafetyStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_interfaces__msg__SafetyStatus(cdr, ros_message);
}

static uint32_t _SafetyStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__SafetyStatus(
...
static size_t _SafetyStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__SafetyStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, SafetyStatus)() {
