...
class VehicleStatus(metaclass=Metaclass_VehicleStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.yaw_rate_rps = kwargs.get('yaw_rate_rps', float())
    ...
    def __eq__(self, other):
        ...
        if self.speed_mps != other.speed_mps:
            return False
        if self.yaw_rate_rps != other.yaw_rate_rps:
            return False
    ...
    @builtins.property
    def yaw_rate_rps(self):
        """Message field 'yaw_rate_rps'."""
        return self._yaw_rate_rps

    @yaw_rate_rps.setter
    def yaw_rate_rps(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'yaw_rate_rps' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'yaw_rate_rps' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._yaw_rate_rps = value
